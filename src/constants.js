...
export const PLYER1_TANK_START_X = 4 * UNIT_SIZE;
export const PLYER1_TANK_START_Y = 12 * UNIT_SIZE;
...
export const PLYER1_TANK_SPRITES = [
...
export const STEEL_WALL_SPRITES =[
    ...
    [24 * UNIT_SIZE, 4.5 * UNIT_SIZE, TILE_SIZE, TILE_SIZE],  // top
]