...
export default class World {
  constructor() {
    ...
    this.player1Tank = new Tank({
      x: constants.PLYER1_TANK_START_X,
      y: constants.PLYER1_TANK_START_Y,
      width: constants.TANK_WIDTH,
      height: constants.TANK_HEIGHT,
      sprites: constants.PLYER1_TANK_SPRITES,
  ...
  get objects() {
    return [this.base, this.player1Tank, ...this.stage.objects, ...this.enemyTanks];
  }
  setStage(date) {
    this.stage = new Stage(date);
  }
